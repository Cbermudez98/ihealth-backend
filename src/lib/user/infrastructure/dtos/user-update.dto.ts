...
import { AuthUpdateDto } from '../../../../lib/auth/infrastructure/dtos/auth-update.dto';
import { IAuthUpdateDto } from '../../../../lib/auth/domain/interfaces/IAuth';
...
import { RoleAssignUpdateDto } from '../../../../lib/role/infrastructure/dtos/role-assign-update.dto';
import { IRoleAssignUpdate } from '../../../../lib/role/domain/interfaces/IRole';
